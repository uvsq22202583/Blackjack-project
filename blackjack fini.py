...
def fonction_nom() :                                                                                        #fonction qui permet de convertir le nom du joueur en str 
    global nomString
    nomString = nomString.get()
    nomString = str(nomString)
    return nomString

racine_nom = tk.Tk()                                                                                        #Création de la fenêtre racine_nom
...
labelmise.grid(column=0, row=3, padx= 250, pady=200)                                                        #placement du label pour le nom
nomString = tk.StringVar()                                                                                  #variable pour le nom du joueur
entrynom = tk.Entry(racine_nom, textvariable=nomString, fg="red", font=("roadstore","20"))                  #création de la cellule d'écriture
entrynom.grid(column=1, row=3, padx=0, pady=200)                                                            #placement du label d'ecriture
ok_mise = tk.Button(racine_nom, fg = "red", text="ok",font=("roadstore","20"), command = fonction_nom)      #création du bouton ok
ok_mise.grid(column = 2, row = 3, padx=50, pady=200)                                                        #placement du bouton ok                                                                                                           
...
racine_nom.mainloop()                                                                                       #lancement de la fenetre racine_nom                                                                        #lancement de la boucle racine



def fonction_mise() :                                                                                      #fonction qui permet de convertir la mise en int
    global miseString
...
racine_mise = tk.Tk()                                                                                        #Création de la fenêtre racine_mise
...
labelimage.place(x=-200,y=-3)                                                                                #placement de l'image
labelmise = tk.Label(racine_mise, fg="red", text = "Quel est votre mise ",font=("roadstore","20"))           #création du label pour demander la mise
labelmise.grid(column=0, row=3, padx= 250, pady=200)                                                         #placement du label pour demander la mise
miseString = tk.StringVar()                                                                                  #variable pour la mise du joueur
entrynom = tk.Entry(racine_mise, textvariable=miseString, fg="red", font=("georgia","20"))                   #création de la cellule d'écriture
entrynom.grid(column=1, row=3, padx=0, pady=200)                                                             #placement du label d'écriture
ok_mise = tk.Button(racine_mise, fg = "red", text="ok",font=("roadstore","20"), command = fonction_mise)     #création du bouton valider
ok_mise.grid(column = 2, row = 3, padx=50, pady=200)                                                         #placement du bouton valider                                                               
...
valider_mise.grid(column = 3, row = 3, padx=50, pady=200)                                                    #placement du label pour demender le nom #placement de la cellule d'ecrit
racine_mise.mainloop()                                                                                       #lancement de la boucle racine_mise
...
#while croupier < 17 :                                                                                                                    #condition où le croupier n'a pas le choix de pioché
#    racine = tk.Tk()                                                                                                                     #Création de la fenêtre racine
#    racine.title("Un premier exemple")                                                                                                   #ajoute un titre
#    racine.attributes("-fullscreen", True)                                                                                               #dimension de la fenetre
#    racine.configure(bg="green")                                                                                                         #fond d'écran vert
#    croupier = tirer_une_carte_alé_deux_plus_joueur(croupier)                                                                            #associer le nouveau score
...
#    valider_nom.grid(column = 2, row = 3, padx=50, pady=200)                                                                             #placement du bouton valider
#    racine.mainloop                                                                                                                      #lancement de la fenetre racine            
#while croupier < 21:                                                                                                                     #condition pour demander au croupier
#    if stop_croupier == False :                                                                                                          #vérifier que le croupier n'a pas dit non
#        racine = tk.Tk()                                                                                                                 #Création de la fenêtre racine
#        racine.title("Blackjack")                                                                                                        #ajoute un titre
#        racine.attributes("-fullscreen", True)                                                                                           #dimension de la fenetre
#        img = tk.PhotoImage(file = "projets\photo du tapis de blackjack.png")                                                            #définition de l'image de fond
...
labelimage.place(x=-200,y=-3)                                                                                                            #placement du label image                                                           
if (joueur_1 > 21 and croupier > 21) or (joueur_1 == 21 and croupier == 21) or (joueur_1 < 21 and croupier < 21 and croupier == joueur_1):      #condition ou il y a égalité
    ...
    label_resultat.grid(column=0, row=3, padx= 250, pady=200)                                                                                   #placement du label pour demender le nom  
    racine_resultat.mainloop()                                                                                                                  #lancement de la boucle racine
elif (croupier > 21 and joueur_1 <= 21) or (croupier < 21 and joueur_1 == 21 ) or (croupier<21 and joueur_1<21 and croupier<joueur_1):                                     #condition ou le joueur gagne
...
elif (croupier <= 21 and joueur_1 > 21) or (croupier == 21 and joueur_1 < 21) or (croupier<21 and joueur_1<21 and croupier>joueur_1):           #condition où le croupier gagne
