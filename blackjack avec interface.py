...
def afficher_nouveau_score(joueur):                                           #fonction qui permet d'afficher 
    ...
    label_joueur.grid(row=2, column=0, padx= 150)                             #placement du label qui donne le nom du score
    ...
    valider_main.grid(row = 1, column = 1, padx=50, pady=200)                 #placement du bouton valider 
...
while joueur_1 < 21:                                                                                                                     #tant que le score du joueur est inférieur à 21
    if stop == False :                                                                                                                   #si stop est égale à False continuer
        ...
        racine.title("Blackjack")                                                                                                        #ajoute un titre
        racine.attributes("-fullscreen", True)                                                                                           #dimension de la fenetre
        racine.configure(bg="green")                                                                                                     #fond d'écran en vert
...
racine.attributes("-fullscreen", True)              #dimension de la fenetre
racine.configure(bg="green")                        #le fond d'écran est vert
label = tk.Label(racine, fg="red", text= " Croupier vous aviez pioché un"+ str(carte_tirée[0])+" et un"+ str(carte_tirée[2]), font=("roadstore", "20"))  # création du widget qui indique les cartes que le croupier à pioché
...
if joueur_1 > 21 and croupier > 21 :
    racine_nom = tk.Tk()                                                                                        #Création de la fenêtre racine
    racine_nom.title("Blackjack")                                                                               #ajoute un titre
    racine_nom.attributes("-fullscreen", True)                                                                  #dimension de la fenetre
    img = tk.PhotoImage(file = "projets\photo du tapis de blackjack.png")                                       #définition de l'image de fond
    ...
    labelimage = tk.Label(racine_nom, image = img)                                                              #création du label image
    labelimage.place(x=-200,y=-3)                                                                               #placement du label image
    label_resultat = tk.Label(racine_nom, fg="red", text = " Vous êtes à égalité ",font=("roadstore","20"))             #création du label pour demander le nom
...
if joueur_1 == 21 and croupier == 21: 
    ...
    label_resultat.grid(column=0, row=3, padx= 250, pady=200)                                                         #placement du label pour demender le nom                                                 #placemenet du bouton valider
    racine_nom.mainloop()    
if joueur_1 < 21 and croupier < 21 and croupier == joueur_1 :
    racine_nom = tk.Tk()                                                                                        #Création de la fenêtre racine
    racine_nom.title("Blackjack")                                                                               #ajoute un titre
    racine_nom.attributes("-fullscreen", True)                                                                  #dimension de la fenetre
    img = tk.PhotoImage(file = "projets\photo du tapis de blackjack.png")                                       #définition de l'image de fond
    ...
    label_resultat.grid(column=0, row=3, padx= 250, pady=200)                                                         #placement du label pour demender le nom                                                 #placemenet du bouton valider
    racine_nom.mainloop()       
if croupier > 21 and joueur_1 <= 21:
    racine_nom = tk.Tk()                                                                                        #Création de la fenêtre racine
    racine_nom.title("Blackjack")                                                                               #ajoute un titre
    racine_nom.attributes("-fullscreen", True)                                                                  #dimension de la fenetre
    img = tk.PhotoImage(file = "projets\photo du tapis de blackjack.png")                                       #définition de l'image de fond
    ...
    labelimage = tk.Label(racine_nom, image = img)                                                              #création du label image
    labelimage.place(x=-200,y=-3)                                                                               #placement du label image
    label_resultat = tk.Label(racine_nom, fg="red", text = str(nomString) + " vous avez gagné, vous avez remporté  " + str(miseString),font=("roadstore","20"))             #création du label pour demander le nom
    label_resultat.grid(column=0, row=3, padx= 250, pady=200)                                                         #placement du label pour demender le nom                                                 #placemenet du bouton valider
    racine_nom.mainloop()    
if croupier <= 21 and joueur_1 > 21:
    racine_nom = tk.Tk()                                                                                        #Création de la fenêtre racine
    ...
    labelimage = tk.Label(racine_nom, image = img)                                                              #création du label image
    labelimage.place(x=-200,y=-3)                                                                               #placement du label image
    label_resultat = tk.Label(racine_nom, fg="red", text = " le croupier a gagné ",font=("roadstore","20"))             #création du label pour demander le nom
    label_resultat.grid(column=0, row=3, padx= 250, pady=200)                                                         #placement du label pour demender le nom                                                 #placemenet du bouton valider
    racine_nom.mainloop()    
if croupier == 21 and joueur_1 < 21 :
    racine_nom = tk.Tk()                                                                                        #Création de la fenêtre racine
...
if croupier < 21 and joueur_1 == 21 :
    ...
    labelimage = tk.Label(racine_nom, image = img)                                                              #création du label image
    labelimage.place(x=-200,y=-3)                                                                               #placement du label image
    label_resultat = tk.Label(racine_nom, fg="red", text = str(nomString) + " vous avez gagné, vous avez don renporté " + str(miseString),font=("roadstore","20"))             #création du label pour demander le nom
    label_resultat.grid(column=0, row=3, padx= 250, pady=200)                                                         #placement du label pour demender le nom                                                 #placemenet du bouton valider
    racine_nom.mainloop()
